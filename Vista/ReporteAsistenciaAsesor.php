...
if (isset($_SESSION['usuario'])) {
    ...
    $verificar->validarInicioSesion($Activo,"asesor");
        ...
        <body>
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <?php echo $Activo.' '; ?><i class="fa fa-user fa-fw"></i>  <i class="fa fa-caret-down"></i>
                </a>
    ...
    <form id = "ordenc" method = "post" action="" role="form" enctype="multipart/data-form" onsubmit="return validarCampos(ordenc)">
                        <div class ="form-horizontal">
                            ...
                            <div class="historia1">
                                ...
                                <?php
                                $peticionActividad = $conexion->query("SELECT r.id_r, nombre_r, f_r.fecha_fr FROM registro r, fecha_realizacion f_r  WHERE r.NOMBRE_U='$GrupoE' and r.TIPO_T='actividad planificacion' and f_r.ID_R = r.ID_R");
                                while ($filaActividad = $peticionActividad->fetch(PDO::FETCH_ASSOC)) {
                                    $peticion =$conexion->query("SELECT CODIGO_S, NOMBRES_S, APELLIDOS_S FROM socio WHERE NOMBRE_U = '$GrupoE'");
