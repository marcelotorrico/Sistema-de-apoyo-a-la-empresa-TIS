    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
           ...
           <div class="sidebar-collapse">      
            ...
            <input class='form-control' type='text' name='login' id='UserName'  value='".$fila['NOMBRE_U']."' pattern='^[a-zA-Z]{3}[a-zA-z0-9_\\_\ü]{0,9}$' title='Minimo 3 caracteres y Maximo 12. Los primeros tres caracteres tienen que ser letras. Ejm: Leticia1, Rolando2' required/>
            </div>
            </div>
            </td>
            </tr>
            ...
            <input class='form-control' type='text' name='password' id='UserPassword' value='".$fila['PASSWORD_U']."' title='Ingrese una contraseña segura, debe tener como minimo 8 caracteres' required/>
            </div>
            </div>  
            ...
            <input class='form-control' type='text' name='nombre' id='RealName' placeholder='Nombre' pattern='[A-Z]{1}[a-z]{2,20}$' title='El nombre debe empezar con mayuscula y como minimio debe poseer 3 caracteres. Ejm: Daniel, Marcelo, Rolando'  value='".$fila['NOMBRES_AD']."' required />
            </div>
            </div>                                                                                                
            ...
            <input class='form-control' type='text' name='apellido' id='LastName' placeholder='Apellido' pattern='[A-Z]{1}[a-z]{2,20}\s?([A-Z]{1}[a-z]{2,20})?' title='El apellido debe empezar con mayuscula y como minimio debe poseer 3 caracteres. Ejm: Vargas, Morales, Medrano' value='".$fila['APELLIDOS_AD']."' required>
            </div>
            </div>                                                                                                
            ...
            <input class='form-control' type='text' name='telefono' id='UserPhone' title='Ejemplo: 4022371, 71759599, 67241212' pattern='^(([4][0-9]{6})|([7|6][0-9]{7}))$' value='".$fila['TELEFONO_U']."' required/>
            </div>
            </div>                                                                                               
            ...
            <input class='form-control' type='email' name='email' id='UserEmail' pattern='^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$' value='".$fila['CORREO_ELECTRONICO_U']."' title='Ingrese un correo valido. Ejm: admin@hotmail.com ,admin@yahoo.com, admin@gmail.com' required/>
            </div>
            </div>
