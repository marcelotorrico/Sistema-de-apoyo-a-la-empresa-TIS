<?php
	...
	class Registro {
	    ...
	    function insertarBD() {
	        $this->conexion->query("INSERT INTO registro(nombre_u, tipo_t, estado_e, nombre_r, fecha_r, hora_r)
	        						   VALUES('$this->usuario', '$this->tipo', '$this->estado', '$this->nombre', '$this->fecha', '$this->hora');");	        
	    }

	    public function modificarBD() {	        
	        $this->conexion->query("UPDATE registro 
	    ...
	    public static function listaActividadesPlanificacion($usuario) {	        
	        $actividadesPlanificacion = $this->conexion->consultarTabla("SELECT id_r, nombre_r 
                                                                    FROM registro
